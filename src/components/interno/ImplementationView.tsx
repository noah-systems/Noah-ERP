...
import { Calendar, CheckCircle, MoreVertical } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
      ...
      {USE_MOCK ? (
        ...
        <MockDataNotice description="O módulo de implantação exibirá os projetos assim que os dados estiverem sincronizados com a API." />
      )}
    </div>
  );
}
