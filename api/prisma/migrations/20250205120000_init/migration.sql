-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('ADMIN_NOAH', 'SALES', 'IMPLEMENTATION');
...
CREATE TABLE "User" (
    ...
    "role" "UserRole" NOT NULL DEFAULT 'ADMIN_NOAH',
...
-- AddForeignKey
ALTER TABLE "Implementation" ADD CONSTRAINT "Implementation_opportunityId_fkey" FOREIGN KEY ("opportunityId") REFERENCES "Opportunity"("id") ON DELETE CASCADE ON UPDATE CASCADE;
